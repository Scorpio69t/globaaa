...
type Share struct {
	Sharee_  string // Name of the entry
	WritePerm_ bool   // True if the entry has writePerm
}

func (d Share) WritePerm() bool  { return d.WritePerm_ }
func (d Share) Sharee() string { return d.Sharee_ }

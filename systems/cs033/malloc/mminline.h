...
// directly)
// NOTE: b->payload[(b->size / WORD_SIZE) - 2] refers to the end-tag
...
// returns the size of the block's payload
...
// Sets the payload size of the block, at both the beginning and the end tags.
...
// ALIGNMENT - 1,
// which is 00..00111 in binary if ALIGNMENT is 8.

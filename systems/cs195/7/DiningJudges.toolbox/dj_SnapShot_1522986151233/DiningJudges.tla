...
TakeLeft ==
    \E j \in judges :
        ...
        /\ LeftChopstickOf(j) \notin judgeState[j]
        /\ chopState[LeftChopstickOf(j)]' = [chopState EXCEPT ![LeftChopstickOf(j)] = "taken"]
        /\ judgeState[j]' = judgeState[j] \union LeftChopstickOf(j)
...
TakeRight == 
    \E j \in judges :
        ...
        /\ judgeState[j]' = judgeState[j] \union RightChopstickOf(j)
